...
export class BodyProgressController {
  ...
  @ApiOperation({
    ...
    description:
      'Records detailed body measurements and progress data for gym members including weight, body fat percentage, measurements, and progress photos. This endpoint allows trainers and gym staff to track member physical progress over time.',
  })
  @ApiResponse({
    status: 201,
    ...
    schema: {
      ...
      properties: {
        ...
        measurements: {
          type: 'object',
          example: { chest: 102, waist: 85, arms: 35 },
        },
        progressPhotoUrl: {
          type: 'string',
          example: 'https://storage.example.com/progress/123_2024_01_15.jpg',
        },
        notes: {
          type: 'string',
          example: 'Significant improvement in muscle definition',
        },
        recordedAt: {
          type: 'string',
          format: 'date-time',
  ...
  @ApiResponse({
    status: 400,
    description: 'Invalid body progress data provided.',
  })
  @ApiResponse({
    status: 403,
    description:
  ...
  @ApiResponse({
    status: 409,
    description: 'Duplicate progress record for the same date.',
  })
  @ApiBody({
    type: CreateBodyProgressDto,
    description:
      'Body progress data including measurements, weight, and optional progress photos',
    examples: {
      basic_entry: {
      ...
      with_photo: {
        ...
        value: {
          ...
          progressPhotoUrl:
            'https://storage.example.com/progress/123_progress_2024_02_15.jpg',
          notes:
            'Great progress! Weight loss of 2.3kg with maintained muscle mass',
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves comprehensive list of body progress records across all members. Supports filtering by date range, member, and pagination for large datasets. Requires admin or trainer permissions.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Sort field (recordedAt, weight, createdAt)',
    example: 'recordedAt',
    enum: ['recordedAt', 'weight', 'createdAt', 'bodyFatPercentage'],
  })
  @ApiQuery({
    name: 'sortOrder',
    required: false,
        ...
        data: {
          ...
          items: {
            ...
            properties: {
              ...
              measurements: {
                type: 'object',
                example: { chest: 102, waist: 85 },
              },
              progressPhotoUrl: {
                type: 'string',
                example:
                  'https://storage.example.com/progress/123_2024_01_15.jpg',
              },
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves detailed information about a specific body progress record by its unique identifier. Includes complete member information and progress photos if available.',
  })
  @ApiParam({
    name: 'id',
    ...
    schema: {
      ...
      properties: {
        ...
        progressPhotoUrl: {
          type: 'string',
          example:
            'https://storage.example.com/progress/123_progress_2024_01_15.jpg',
        },
        beforePhotoUrl: {
          type: 'string',
          example:
            'https://storage.example.com/progress/123_before_2023_12_01.jpg',
        },
        notes: {
          type: 'string',
          example:
            'Significant improvement in muscle definition. Member is very motivated.',
        },
        recordedAt: {
          type: 'string',
          format: 'date-time',
  ...
  @ApiResponse({
    status: 400,
    description: 'Invalid progress record ID provided.',
  })
  @ApiResponse({
    status: 403,
    description:
  ...
  @ApiResponse({
    status: 404,
    description: 'Body progress record not found or does not exist.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Updates an existing body progress record with new measurements, photos, or notes. Only the creator of the record or users with appropriate permissions can modify the data. Useful for correcting measurement errors or adding follow-up notes.',
  })
  @ApiParam({
    name: 'id',
    ...
    schema: {
      ...
      properties: {
        ...
        progressPhotoUrl: {
          type: 'string',
          example:
            'https://storage.example.com/progress/123_updated_2024_01_15.jpg',
        },
        notes: {
          type: 'string',
          example: 'Updated measurements - corrected waist measurement',
        },
        recordedAt: {
          type: 'string',
          format: 'date-time',
        ...
        message: {
          type: 'string',
          example: 'Body progress record updated successfully',
        },
      },
    },
  })
  ...
  @ApiBody({
    ...
    description:
      'Updated body progress data - only include fields that need to be updated',
    examples: {
      measurement_update: {
      ...
      add_photo: {
        ...
        value: {
          progressPhotoUrl:
            'https://storage.example.com/progress/123_new_photo_2024_01_20.jpg',
          notes:
            'New progress photo added showing significant muscle definition improvement',
        },
      },
    },
  })
  ...
  @ApiOperation({
    ...
    description:
      'Permanently removes a body progress record from the system. This action cannot be undone. Only admins, the record creator, or users with appropriate permissions can delete progress records. Progress photos will also be removed from storage.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Body progress record deleted successfully',
        },
        deletedRecord: {
          type: 'object',
          properties: {
  ...
  @ApiResponse({
    status: 409,
    description: 'Cannot delete record - it has associated dependent records.',
  })
  remove(
    @Param('id', ParseIntPipe) id: number,
    @CurrentUser() user: UserEntity,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all body progress records for a specific gym member, ordered chronologically from oldest to newest. Useful for tracking member progress over time and generating progress reports.',
  })
  @ApiParam({
    name: 'memberId',
  ...
  @ApiQuery({
    ...
    required: false,
    type: Boolean,
    description: 'Whether to include progress photo URLs in response',
    example: true,
  })
  @ApiQuery({
    name: 'startDate',
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all body progress records that were created by the currently authenticated user (trainer/staff). Useful for trainers to review their own measurement entries and track their assigned members progress.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiResponse({
    status: 200,
    description:
      'Successfully retrieved body progress records created by current user',
    schema: {
      type: 'object',
      properties: {
        data: {
