...
import { SubscriptionsController, MemberSubscriptionsController } from './subscriptions.controller';
...
@Module({
  imports: [TypeOrmModule.forFeature([MemberSubscription, Member, MembershipPlan])],
