...
export class UsersController {
  ...
  @ApiOperation({ 
    ...
    description: 'Updates an existing user with new information. Requires admin privileges or self-update.'
  })
  @ApiParam({ 
    name: 'id', 
    description: 'User ID',
  ...
  @ApiOperation({ 
    ...
    description: 'Deletes a user account permanently. Requires admin privileges. This action cannot be undone.'
  })
  @ApiParam({ 
    name: 'id', 
    description: 'User ID',
