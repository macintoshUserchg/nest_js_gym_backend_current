...
export class CreateTrainerDto {
  ...
  @ApiPropertyOptional({ description: 'Trainer specialization', example: 'Yoga, Pilates' })
  @IsString()
  @IsOptional()
  specialization?: string;

  @ApiPropertyOptional({ description: 'Trainer avatar URL', example: 'https://example.com/avatar.jpg' })
  @IsString()
  @IsOptional()
  avatarUrl?: string;
