...
export class ClassesController {
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieve all classes with optional filtering by branch, timing, or day'
  })
  @ApiQuery({
    name: 'branchId',
    required: false,
    type: String,
    description: 'Filter classes by branch ID',
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Filter by class timing',
    example: 'morning',
  ...
  findAll(
    ...
    return this.classesService.findAll(branchId, timing, day);
  }
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieves detailed information about a specific fitness class including schedule, capacity, instructor details, and current enrollment status.'
  })
  @ApiParam({ 
    name: 'id', 
  ...
  @ApiResponse({ 
    status: 403, 
    description: 'Forbidden - Insufficient permissions to access class information.' 
  })
  @ApiResponse({ 
    status: 404, 
    description: 'Class not found - The specified class ID does not exist or has been removed.' 
  })
  @ApiResponse({ 
    status: 500, 
  ...
  @ApiOperation({ 
    ...
    description: 'Updates class information including schedule, capacity, instructor assignment, and recurrence rules. Only admin and branch managers can update class details.'
  })
  @ApiParam({ 
    name: 'id', 
  ...
  @ApiResponse({ 
    status: 400, 
    description: 'Invalid input data - Check validation errors for class capacity, timing conflicts, or instructor availability.' 
  })
  @ApiResponse({ 
    status: 401, 
    description: 'Unauthorized - Invalid or missing JWT token.' 
  ...
  @ApiResponse({ 
    status: 403, 
    description: 'Forbidden - Insufficient permissions to update class information.' 
  })
  @ApiResponse({ 
    status: 404, 
  ...
  @ApiResponse({ 
    status: 409, 
    description: 'Schedule conflict - Class timing conflicts with existing classes or instructor availability.' 
  })
  @ApiResponse({ 
    status: 500, 
  ...
  @ApiBody({ 
    type: UpdateClassDto,
    description: 'Updated class data with new schedule, capacity, or instructor information',
    examples: {
      scheduleUpdate: {
  ...
  @ApiOperation({ 
    ...
    description: 'Permanently removes a fitness class from the system. This action cannot be undone and will also remove all associated enrollments and attendance records. Only super admins can delete classes.'
  })
  @ApiParam({ 
    name: 'id', 
  ...
  @ApiResponse({ 
    status: 200, 
    description: 'Class deleted successfully - All associated records have been removed.' 
  })
  @ApiResponse({ 
    status: 401, 
    description: 'Unauthorized - Invalid or missing JWT token.' 
  ...
  @ApiResponse({ 
    status: 403, 
    description: 'Forbidden - Insufficient permissions to delete class. Only super admins can perform this action.' 
  })
  @ApiResponse({ 
    status: 404, 
    description: 'Class not found - The specified class ID does not exist.' 
  ...
  @ApiResponse({ 
    status: 409, 
    description: 'Cannot delete class - Class has active enrollments or scheduled sessions. Please cancel all enrollments first.' 
  })
  @ApiResponse({ 
    status: 500, 
...
export class BranchClassesController {
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieves all fitness classes available at a specific branch, including class schedules, capacity, and instructor information. Useful for branch managers to view their class offerings.'
  })
  @ApiParam({ 
    name: 'branchId', 
  ...
  @ApiResponse({ 
    status: 403, 
    description: 'Forbidden - Insufficient permissions to access branch classes.' 
  })
  @ApiResponse({ 
    status: 404, 
    description: 'Branch not found - The specified branch ID does not exist or you do not have access to it.' 
  })
  @ApiResponse({ 
    status: 500, 
...
export class GymClassesController {
  ...
  @ApiResponse({
    status: 404,
    description: 'Gym not found - The specified gym ID does not exist or you do not have access to it.',
  })
  @ApiResponse({
    status: 500,
